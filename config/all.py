# -*- coding: utf-8 -*-
#
# QuickAppsCMS Book documentation build configuration file, created by
# sphinx-quickstart on Tue Aug 26 19:29:12 2014.
#
...
html_short_title = u'QuickBook 2.x'
...
htmlhelp_basename = 'QuickAppsCMSBookdoc'
...
texinfo_documents = [
  ('contents', 'QuickAppsCMSBook', u'QuickAppsCMS Book Documentation',
   u'Christopher Castro', 'QuickAppsCMSBook', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_identifier = 'http://quickappscms.org'
