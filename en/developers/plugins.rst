...
plugin's `Event Listener <events.md#registering-listeners>`__ classes
and it must return an associative array for setting keys and their
values, a full example:
